...
import { BittrexFeed } from "gdax-trading-toolkit/build/src/exchanges/bittrex/BittrexFeed";
import { FeedFactory as BittrexFeedFactory } from "gdax-trading-toolkit/build/src/factories/bittrexFactories"
import { OrderbookMessage } from "gdax-trading-toolkit/build/src/core";

const logger = GTT.utils.ConsoleLoggerFactory();
const products: string[] = ['BTC-ETH', 'ETH-NEO'];
const tallies: any = {};
...
BittrexFeedFactory(logger, products).then((feed: BittrexFeed) => {
